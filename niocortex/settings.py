...
INSTALLED_APPS = [
    ...
    # --- 1. Módulos de Entrada e Identidade ---
    'stage.publico',      # Site Público, Landing Page, Vendas
    'yourlife.social',    # Rede Social, Perfil, Autenticação
    'core',               # Núcleo, Usuários (CustomUser), APIs Internas

    # --- 2. Módulos de Gestão (ERP NioCortex) ---
    'prioris.direcao',    # Gestão Estratégica
    'humanex.rh',         # Recursos Humanos
    'ledger.financeiro',  # Financeiro e Patrimônio
    'hub.secretaria',     # Secretaria e Documentação
    'orbit.coordenacao',  # Coordenação Pedagógica
    'vionex.crm',         # CRM e Captação

    # --- 3. Módulos de Ensino (LMS Lumenios) ---
    'lumenios.pedagogico', # Gestão Acadêmica (Notas, Turmas)
    'lumenios.plataforma', # AVA (Ambiente Virtual de Aprendizagem)
]
