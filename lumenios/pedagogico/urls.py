...
urlpatterns = [
    ...
    path('turmas/nova/', views.form_turmas, name='form_turmas'),  # ADICIONADO
        path('turmas/editar/<uuid:turma_id>/', views.editar_turma, name='editar_turma'),
    ...
    path('turmas/<uuid:turma_id>/adicionar-aluno/', views.adicionar_aluno, name='adicionar_aluno'),
