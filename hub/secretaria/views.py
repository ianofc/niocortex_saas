...
def listar_modelos(request):
    ...
    return render(request, 'secretaria/modelos/listar_modelos.html', {'modelos': modelos})
...
def criar_modelo(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('hub_secretaria:listar_modelos')
    else:
        form = ModeloDocumentoForm()
    
    return render(request, 'secretaria/modelos/form_modelos.html', {'form': form, 'titulo': 'Novo Modelo de Documento'})
...
def selecionar_aluno_emissao(request):
    ...
    return render(request, 'secretaria/emissao/selecionar_aluno.html', {'alunos': alunos})
...
def gerar_documento(request, aluno_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect('hub_secretaria:visualizar_documento', doc_id=doc.id)
        except Exception as e:
            messages.error(request, str(e))

    return render(request, 'secretaria/emissao/gerar_documento.html', {'aluno': aluno, 'modelos': modelos})
...
def visualizar_documento(request, doc_id):
    ...
    return render(request, 'secretaria/emissao/visualizar_impressao.html', {'documento': documento})