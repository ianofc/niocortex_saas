...
urlpatterns = [
    ...
    path('identidade/', aluno.student_id_card, name='student_id_card'),
    ...
    path('api/ia/check/', ia.api_check_conscios, name='api_check_conscios'),
    path('api/ia/chat/', ia.api_chat_conscios, name='api_chat_conscios'),
]